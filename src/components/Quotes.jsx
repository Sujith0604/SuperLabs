const Quotes = () => {
  return (
    <div className=" h-[300px] bg-red-600 flex flex-col items-center justify-center">
      <div className=" md:w-[75%] flex flex-col items-center justify-center gap-5 ">
        {" "}
        ...
        <p className=" md:text-xl text-[17px]  text-center text-white">
